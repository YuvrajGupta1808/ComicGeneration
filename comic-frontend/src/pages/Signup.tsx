...
const Signup: React.FC<SignupProps> = ({ onSignup }) => {
  ...
  const handleSocialSignup = (provider: string) => {
    // Mock social signup - in production, integrate with OAuth
    ...
    <div className="min-h-screen bg-gradient-to-b from-purple-100/30 via-blue-100/40 to-indigo-100/50 dark:from-neutral-950 dark:via-neutral-950 dark:to-neutral-900 flex flex-col">
      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-white dark:bg-neutral-900 rounded-2xl border border-gray-200 dark:border-neutral-800 p-8 shadow-xl">
          <h1 className="text-2xl font-bold text-gray-900 dark:text-white mb-2">Join ComicGen AI</h1>
          <p className="text-gray-600 dark:text-neutral-400 mb-8">Create your account in seconds</p>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="flex items-center text-sm">
              <input
                ...
                required
              />
              <label className="ml-2 text-gray-600 dark:text-neutral-400">
                I agree to the{' '}
                <button type="button" onClick={() => alert('Terms of Service')} className="font-semibold text-gray-900 dark:text-white hover:text-gray-700 dark:hover:text-gray-300">
                  Terms
                </button>{' '}
                and{' '}
                <button type="button" onClick={() => alert('Privacy Policy')} className="font-semibold text-gray-900 dark:text-white hover:text-gray-700 dark:hover:text-gray-300">
                  Privacy Policy
                </button>
              </label>
            </div>
          ...
          <div className="mt-6 text-center">
            <p className="text-sm text-gray-600 dark:text-neutral-400">
              ...
              <Link to="/login" className="font-semibold text-gray-900 dark:text-white hover:text-gray-700 dark:hover:text-gray-300">
                Sign in
              </Link>
            </p>
          </div>
